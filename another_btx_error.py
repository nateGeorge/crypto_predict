saving ETH-RCN trade history
saving BTC-VIB trade history
saving ETH-VIB trade history
...
Traceback (most recent call last):
  ...
  File "/usr/local/lib/python3.5/dist-packages/OpenSSL/SSL.py", line 1371, in _raise_ssl_error
